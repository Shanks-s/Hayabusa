...
import me.shanks.hayabusa.impl.util.misc.URLUtil;
import me.shanks.hayabusa.installer.service.Srg2NotchService;
            ...
            throws IOException
    {
        if (entry.getName().equals(JarFile.MANIFEST_NAME))
        {
            try (InputStream is = jar.getInputStream(entry))
            {
                ...
                attr.put(new Attributes.Name("HayabusaVanilla"), "true");
